                    ...
                    <Col md={6}>
                        <FormGroup>
                            ...
                            <FormControl type="text" placeholder="City"
                                         isInvalid={!!errors.city} {...register('city', {required: 'City is required'})} />
                    ...
                    <Col md={3}>
                        <FormGroup>
                            ...
                            <FormControl type="text" placeholder="State"
                                         isInvalid={!!errors.state} {...register('state', {required: 'State is required'})} />
                    ...
                    <Col md={3}>
                        <FormGroup>
                            ...
                            <FormControl type="text" placeholder="Zip"
                                         isInvalid={!!errors.zip} {...register('zip', {required: 'Zip is required'})} />
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <FormGroup>
                            <FormLabel>City</FormLabel>
                            <FormControl type="text" placeholder="City"
                                         isInvalid={!!errors.city} {...register('city')} />
                            <Feedback type="invalid">{errors.city?.message}</Feedback>
                        </FormGroup>
                    </Col>
                    <Col md={3}>
                        <FormGroup>
                            <FormLabel>State</FormLabel>
                            <FormControl type="text" placeholder="State"
                                         isInvalid={!!errors.state} {...register('state')} />
                            <Feedback type="invalid">{errors.state?.message}</Feedback>
                        </FormGroup>
                    </Col>
                    <Col md={3}>
