            ...
            <Row>
                <Col lg={6}>
                    <Row className="g-lg-4 g-2">
                        ...
                        <Col lg={8}>
                            <FormControl size="sm" type="text" id="example-input-small" name="example-input-small"
                    ...
                    <Row className="g-lg-4 g-2">
                        ...
                        <Col lg={8}>
                            <FormControl size="lg" type="text" id="example-input-large" name="example-input-large"
                ...
                <Col lg={6}>
                    <Row className="g-lg-4 g-2">
                        ...
                        <Col lg={8}>
                            <FormControl type="text" id="example-input-normal" name="example-input-normal"
                                         placeholder="Normal"/>
                        </Col>
                    </Row>
