                ...
                <Col lg={6}>
                    <Row className="g-lg-4 g-2">
                        ...
                        <Col lg={8}>
                            ...
                            <Form.Check type="checkbox" label="Disabled checked checkbox" checked disabled
                                        className="mb-2" onChange={() => {
                            }}/>
                            ...
                            <div className="d-flex flex-wrap gap-4">
                                <div>
                                    <div className="form-check form-check-primary form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchPrimary" checked
                                               onChange={() => {
                                               }}/>
                                    ...
                                    <div className="form-check form-check-secondary form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchSecondary" checked
                                               onChange={() => {
                                               }}/>
                                    ...
                                    <div className="form-check form-check-success form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchSuccess" checked
                                               onChange={() => {
                                               }}/>
                                    ...
                                    <div className="form-check form-check-info form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchInfo" checked
                                               onChange={() => {
                                               }}/>
                                ...
                                <div>
                                    <div className="form-check form-check-warning form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchWarning" checked
                                               onChange={() => {
                                               }}/>
                                    ...
                                    <div className="form-check form-check-danger form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchDanger" checked
                                               onChange={() => {
                                               }}/>
                                    ...
                                    <div className="form-check form-check-purple form-switch mb-2">
                                        <input type="checkbox" className="form-check-input" id="switchPurple" checked
                                               onChange={() => {
                                               }}/>
                                    ...
                                    <div className="form-check form-check-dark form-switch">
                                        <input type="checkbox" className="form-check-input" id="switchDark" checked
                                               onChange={() => {
                                               }}/>
                ...
                <Col lg={6}>
                    <Row className="g-lg-4 g-2">
                        ...
                        <Col lg={8}>
                            ...
                            <Form.Check type="radio" checked disabled label="Disabled Checked Radio" className="mb-2"
                                        onChange={() => {
                                        }}/>
                    ...
                    <Row className="g-lg-4 g-2">
                        ...
                        <Col lg={8}>
                            <div className="d-flex flex-wrap gap-4">
                                <div>
                                    <div className="form-check form-check-primary mb-2">
                                        <Form.Check type="radio" name="radioPrimary" id="radioPrimary" checked
                                                    onChange={() => {
                                                    }}/>
                                    ...
                                    <div className="form-check form-check-secondary mb-2">
                                        <Form.Check type="radio" name="radioSecondary" id="radioSecondary" checked
                                                    onChange={() => {
                                                    }}/>
                                    ...
                                    <div className="form-check form-check-success mb-2">
                                        <Form.Check type="radio" name="radioSuccess" id="radioSuccess" checked
                                                    onChange={() => {
                                                    }}/>
                                    ...
                                    <div className="form-check form-check-info mb-2">
                                        <Form.Check type="radio" name="radioInfo" id="radioInfo" checked
                                                    onChange={() => {
                                                    }}/>
                                ...
                                <div>
                                    <div className="form-check form-check-warning mb-2">
                                        <Form.Check type="radio" name="radioWarning" id="radioWarning" checked
                                                    onChange={() => {
                                                    }}/>
                                    ...
                                    <div className="form-check form-check-danger mb-2">
                                        <Form.Check type="radio" name="radioDanger" id="radioDanger" checked
                                                    onChange={() => {
                                                    }}/>
                                    ...
                                    <div className="form-check form-check-purple mb-2">
                                        <Form.Check type="radio" name="radioPurple" id="radioPurple" checked
                                                    onChange={() => {
                                                    }}/>
                                    ...
                                    <div className="form-check form-check-dark">
                                        <Form.Check type="radio" name="radioDark" id="radioDark" checked
                                                    onChange={() => {
                                                    }}/>
