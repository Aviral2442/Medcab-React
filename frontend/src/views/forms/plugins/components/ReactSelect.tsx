        ...
        <Card>
            ...
            <CardBody>
                ...
                <Row className="align-items-center g-4">
                    ...
                    <Col lg={6}>
                        <Select className="react-select" classNamePrefix={'react-select'}
                                placeholder="Select City" options={groupedOptions}/>
                    </Col>
                </Row>
                ...
                <Row className="align-items-center g-4">
                    ...
                    <Col lg={6}>
                        <Select className="react-select" classNamePrefix={'react-select'} isSearchable={false}
                                options={basicOptions}/>
                    </Col>
                </Row>
                ...
                <Row className="align-items-center g-4">
                    ...
                    <Col lg={6}>
                        <Select className="react-select" classNamePrefix={'react-select'}
                                closeMenuOnSelect={false} options={basicOptions}/>
                    </Col>
                </Row>
                ...
                <Row className="align-items-center g-4">
                    ...
                    <Col lg={6}>
                        <Select className="react-select" classNamePrefix={'react-select'} isMulti
                                options={basicOptions}/>
                    </Col>
                </Row>
                ...
                <Row className="align-items-center g-4">
                    ...
                    <Col lg={6}>
                        <CreatableSelect className="react-select" classNamePrefix={'react-select'} isClearable
                                         options={basicOptions}/>
                    </Col>
                </Row>
                ...
                <Row className="align-items-center g-4">
                    ...
                    <Col lg={6}>
                        <CreatableSelect className="react-select" classNamePrefix={'react-select'} isClearable isMulti
                                         options={basicOptions}/>
                    </Col>
                </Row>
            </CardBody>
