    ...
    return (
        <Card>
            ...
            <CardBody>
                ...
                <Link className="p-0 fw-semibold" to="https://ericgio.github.io/react-bootstrap-typeahead/"
                      target="_blank">
            ...
            <CardBody>
                ...
                <Row className="g-3">
                    ...
                    <Col lg={6}>
                        <Typeahead className="typeahead" labelKey="state" placeholder="Enter states from USA"
                ...
                <Row className="g-3">
                    ...
                    <Col lg={6}>
                        <Typeahead className="typeahead" labelKey="state" placeholder="Enter states from USA"
                                   options={options} highlightOnlyResult/>
                    </Col>
                </Row>
