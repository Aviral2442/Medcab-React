...
import {tableData} from '@/views/tables/data-tables/data.ts'
    ...
    return (
        <Container fluid>
            <PageTitle
                ...
                subtitle="Enable row selection using checkboxes for bulk actions, form submissions, or item management within DataTables."
                badge={{title: 'Multi-Select', icon: LuSquareCheck}}
            />
