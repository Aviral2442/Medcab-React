    ...
    return (
        <Container fluid>
            <PageTitle
                ...
                subtitle="Customize how data is displayed using render functions, flags, progress, and conditional formatting."
                badge={{title: 'Custom Output', icon: LuLayoutTemplate}}
            />
