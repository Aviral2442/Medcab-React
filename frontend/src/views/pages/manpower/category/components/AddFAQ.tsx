  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "edit" && data) {
        ...
        await axios.put(
          `${baseURL}/manpower/edit_faq/${data.manpower_faq_id}`,
          payload
        );
        onDataChanged();
        onCancel();
      ...
      alert(
        `Failed to save FAQ: ${err.response?.data?.message || err.message}`
      );
    }
  };
              ...
              <Col lg={9}>
                ...
                >
                  ...
                  <FormControl
                    ...
                    onChange={(e) =>
                      handleChange(index, "manpower_faq_header", e.target.value)
                    }
                    required
              ...
              <Col lg={2}>
                <Form.Group controlId={`mpf_status_${index}`} className="mb-0">
                  ...
                  <Form.Select
                    ...
                    onChange={(e) =>
                      handleChange(index, "manpower_faq_status", e.target.value)
                    }
                  >
