...
export const timelineItems1: TimelineItemType[] = [
    {
        time: 'Just Now',
...
export const timelineItems2: TimelineItemType[] = [
    {
        time: '5 mins ago',
...
export const timelineItems3: TimelineItemType[] = [
    {
        time: '10 mins ago',
        icon: TbRocket,
...
export const timelineItems4: TimelineItemType[] = [
    {
        image: user1,
