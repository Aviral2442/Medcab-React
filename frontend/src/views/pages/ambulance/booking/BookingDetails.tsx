  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "Cloud Consumer CRID", name: "bv_cloud_con_crid", editable: false, cols: 6 },
        { label: "Cloud Consumer CRID (C to D)", name: "bv_cloud_con_crid_c_to_d", editable: false, cols: 6 },
        { label: "Includes", name: "booking_view_includes", type: "textarea" as const, rows: 3, cols: 12 },
        { label: "Category Icon", name: "booking_view_category_icon", editable: false, cols: 6 },
        { label: "Polyline", name: "booking_polyline", type: "textarea" as const, rows: 2, editable: false, cols: 6 },
        { label: "AP Polyline", name: "booking_ap_polilyne", type: "textarea" as const, rows: 2, editable: false, cols: 6 },
      ],
    },
  ];
