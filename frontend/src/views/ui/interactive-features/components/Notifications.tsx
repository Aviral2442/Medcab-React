...
const Basic = () => {
    ...
    return (
        <>
            ...
            <div className="p-3">
                <Toast className="fade" role="alert" aria-live="assertive" aria-atomic="true" onClose={hide}
                       show={!isOpen}>
                    <ToastHeader>
            ...
            <Col md={6} className="mt-4">
                <div className="p-3">
                    <div aria-live="polite" aria-atomic="true"
                         className="d-flex justify-content-center align-items-center" style={{minHeight: 200}}>
    ...
    return (
        <>
            <div className="mt-4">
                ...
                <Toast show={isOpenCustom1} onClose={hideCustom1} delay={3000} autohide
                       className="align-items-center mb-4">
                    <div className="d-flex">
                        <ToastBody>Hello, world! This is a toast message.</ToastBody>
                        <Button onClick={hideCustom1} className="btn-close me-2 m-auto" data-bs-dismiss="toast"
                                aria-label="Close"/>
                    </div>
                </Toast>
                <Toast
                    ...
                    <div className="d-flex">
                        <ToastBody>Hello, world! This is a toast message.</ToastBody>
                        <Button onClick={hideCustom2} className="btn-close btn-close-white me-2 m-auto"
