                        ...
                        <tr key={session.id}>
                            <td>
                                <div className="d-flex align-items-center">
                                    <img src={session.user.avatar} alt="" className="avatar-sm rounded-circle me-2"
                                         height={32} width={32}/>
                                    <div>
                            ...
                            <td>
                                ...
                                <h5 className="fs-base mb-0 fw-normal">
                                    <TbCircleFilled
                                        className={`fs-xs ${session.status === 'failed' ? 'text-danger' : ''}`}/>
                ...
                <Row className="align-items-center justify-content-between text-center text-sm-start">
                    <Col className="col-sm">
                        <div className="text-muted">
                            Showing <span className="fw-semibold">1</span> to <span
                            className="fw-semibold">10</span> of <span className="fw-semibold">2684</span>{' '}
                            Sessions
                        </div>
                    </Col>
