...
import type {ChartJSOptionsType, TableType} from '@/types'
...
export const accuracyChart: () => ChartJSOptionsType = () => ({
    data: {
...
export const tokenUsageChart: () => ChartJSOptionsType = () => ({
    data: {
        labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
        datasets: [
            {
...
function generateSmoothData(count: number, start = 40, variation = 5) {
    const data = [start]
...
function generateHigherData(baseData: any, diffRange = [3, 6]) {
    return baseData.map((val: any) => val + Math.floor(Math.random() * (diffRange[1] - diffRange[0] + 1)) + diffRange[0])
}
...
export const activeUsersChart: () => ChartJSOptionsType = () => ({
    data: {
        labels,
        datasets: [
            {
...
export const sessions: SessionType[] = [
    {
        id: '#AI-5001',
        user: {name: 'Alice Cooper', avatar: user1},
        aiModel: 'GPT-4',
        date: '2025-05-01',
        tokens: 2304,
        status: 'completed',
    ...
    {
        id: '#AI-5002',
        user: {name: 'David Lee', avatar: user2},
        aiModel: 'DALL·E',
        date: '2025-04-30',
        tokens: 580,
        status: 'pending',
    ...
    {
        id: '#AI-5003',
        user: {name: 'Sophia Turner', avatar: user3},
        aiModel: 'Whisper',
        date: '2025-04-29',
        tokens: 1102,
        status: 'completed',
    ...
    {
        id: '#AI-5004',
        user: {name: 'James Wilson', avatar: user4},
        aiModel: 'GPT-3.5',
        date: '2025-04-28',
        tokens: 760,
        status: 'failed',
    ...
    {
        id: '#AI-5005',
        user: {name: 'Ava Carter', avatar: user5},
        aiModel: 'Claude 2',
        date: '2025-04-27',
        tokens: 1678,
        status: 'completed',
    ...
    {
        id: '#AI-5006',
        user: {name: 'Ethan Brooks', avatar: user6},
        aiModel: 'Gemini Pro',
        date: '2025-04-26',
        tokens: 945,
        status: 'pending',
    ...
    {
        id: '#AI-5007',
        user: {name: 'Mia Clarke', avatar: user7},
        aiModel: 'GPT-4 Turbo',
        date: '2025-04-25',
        tokens: 2189,
        status: 'completed',
    ...
    {
        id: '#AI-5008',
        user: {name: 'Lucas Perry', avatar: user8},
    ...
    {
        id: '#AI-5009',
        user: {name: 'Chloe Adams', avatar: user9},
        aiModel: 'GPT-4',
        date: '2025-04-23',
        tokens: 1784,
        status: 'completed',
    ...
    {
        id: '#AI-5010',
        user: {name: 'Benjamin Gray', avatar: user10},
        aiModel: 'Whisper',
        date: '2025-04-22',
        tokens: 890,
        status: 'pending',
