...
import type {LayoutPositionType, LayoutThemeType, SideNavType, TopBarType} from '@/types/layout'
...
const sidenavSizeOptions: SideNavSizeOptionType[] = [
    ...
    {size: 'collapse', image: collapsedSideNavImg, label: 'Collapse'},
]
                            ...
                            {layoutPositionOptions.map((item, idx) => (
                                <Fragment key={idx}>
                                    <input
                                        ...
                                        onChange={() => changePosition(item.position)}
                                    />
                                    <label className="btn btn-sm btn-soft-primary w-sm"
