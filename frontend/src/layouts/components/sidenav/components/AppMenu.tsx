                ...
                <div>
                    <ul className="sub-menu">
                        {(item.children || []).map((child) =>
                            child.children ? (
                                <MenuItemWithChildren key={child.key} item={child} openMenuKey={openMenuKey}
                                                      setOpenMenuKey={setOpenMenuKey} level={level + 1}/>
                            ) : (
        ...
        <ul className="side-nav">
            {menuItems.map((item) =>
                item.isTitle ? (
                    ...
                    <MenuItemWithChildren key={item.key} item={item} openMenuKey={openMenuKey}
