                ...
                <DropdownMenu className="p-0 dropdown-menu-lg">
                    ...
                    <SimpleBar style={{maxHeight: '300px'}}>
                        {notifications.map((notification) => (
                            <DropdownItem className="notification-item py-2 text-wrap" key={notification.id}>
                                <span className="d-flex gap-2">
                                  {notification.avatar && (
                                      <span className="flex-shrink-0">
                                      <img src={notification.avatar} className="avatar-md rounded-circle" alt="User Avatar" width={36}
                                           height={36}/>
                                    </span>
                                  )}
                                    {notification.icon && (
                                    ...
                                    {notification.type === 'message' ? (
                                        ...
                                        <span
                                            className="fw-medium text-body">{notification.title ? notification.title : notification.description}</span>
                                    )}
                                        <br/>
