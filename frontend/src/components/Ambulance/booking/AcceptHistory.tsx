...
const AcceptHistory: React.FC<AcceptHistoryProps> = ({
  data,
  loading = false,
  error = null,
  currentPage = 0,
  ...
  console.log("Rendering AcceptHistory with data:", tableData);

  if (error) {
    return (
      <ComponentCard title="Accept History List">
  ...
  return (
    <ComponentCard title="Accept History List" className="mb-2">
      {loading ? (
