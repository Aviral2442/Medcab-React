...
const TouchSpinInput = ({
    ...
    return (
        <div
            className={clsx('input-group touchspin', className, size === 'sm' && 'input-group-sm', size === 'lg' && 'input-group-lg')}>
            <Button variant={variant} className={clsx('floating', buttonClassName)} disabled={props.disabled}
                    onClick={decrement}>
                <TbMinus/>
            </Button>
            <FormControl
