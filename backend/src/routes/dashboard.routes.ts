...
import { consumerCount, latestBookingListOfNewOngoing, latestBookingTransactionList, latestVendorTransList, newOngoingBookingList, totalActiveOtherStatusVendorCounts, totalBookingCount, totalCancelOngoingBookingCounts } from '../controllers/dashboard.controller';
const router = Router();
