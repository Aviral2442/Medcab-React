...
router.get('/get_ambulance_vehicle_number', getAmbulanceVehicleNumberController);
router.get('/ambulance_driver_partner_data_by_vehicleId/:vehicleId', getAmbulanceDriverNameNoUsingVehicleIdController);
