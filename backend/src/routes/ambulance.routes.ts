...
// COUNT DASHBOARD AMBULANCE BOOKING ROUTE
router.get('/count_dashboard_ambulance_bookings', countDashboardAmbulanceBookingController);
router.get('/partner_count_dashboard_ambulance', partnerDashboardCountController);
router.get('/driver_count_dashboard_ambulance', driverDashboardCountController);
...
// AMBULANCE FACILITIES ROUTES
router.get("/get_ambulance_facilities_list", getAmbulanceFacilitiesListController);
router.post("/add_ambulance_facilities", addAmbulanceFacilitiesController);
router.get("/get_ambulance_facilities/:id", getAmbulanceFacilitiesController);
router.put("/edit_ambulance_facilities/:id", editAmbulanceFacilitiesController);
router.patch("/update_ambulance_facilities_status/:id", updateAmbulanceFacilitiesStatusController);
...
router.get('/get_ambulance_consumer_mobile', getAmbulanceConsumerMobileController);
router.get('/get_vehicle_and_assign_data', getAmbulanceVehicleAndAssignDataController);
router.post('/assign_driver/:bookingId', assignDriverController);
router.get('/cancel_booking_reasons_data', cancelReasonController);
router.patch('/cancel_ambulance_booking/:bookingId', cancelAmbulanceBookingController);
router.post('/verify_otp/:bookingId', verifyOTPAmbulanceBookingController);
router.post('/cancel_driver_from_ambulance_booking/:id', cancelDriverFromAmbulanceBookingController);
router.patch('/update_ambulance_booking_amount/:bookingId', updateAmbulanceBookingAmountController);
router.post('/complete_ambulance_booking/:bookingId', completeAmbulanceBookingController);
router.post('/generate_ambulance_booking_invoice/:bookingId',generateAmbulanceBookingInvoiceController);
router.get('/ambulance_booking_invoice/:bookingId',ambulanceBookingInvoiceController);
router.get('/ambulance_booking_remark_list/:bookingId', ambulanceBookingRemarkListController);
router.get('/ambulance_booking_state_wise_list/:bookingId', ambulanceBookingStateWiseListController);
router.get('/ambulance_booking_city_wise_list/:bookingId', ambulanceBookingCityWiseListController);
router.get('/ambulance_booking_nearest_driver_and_vehicle_data/:bookingId', ambulanceBookingNearestDriverAndVehicleDataController);
router.get('/ambulance_booking_map_data/:bookingId', ambulanceBookingMapDataController);
router.get('/ambulance_booking_accept_history/:bookingId', ambulanceAcceptHistoryListController);
router.get('/ambulance_booking_reject_history/:bookingId', ambulanceRejectHistoryListController);
